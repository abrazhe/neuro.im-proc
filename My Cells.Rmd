...
```{python}
names.pop(names.index('/home/incredible/Neuroscience/selected-for-complexity/data/4wk-both5-red-raw.pic'))
```
...
k = randint(len(names))
k = 0
k = names.index('/home/incredible/Neuroscience/selected-for-complexity/data/3wk-ly1-raw.pic')
print(k, names[k])
...
```{python}
# %time data_sato, Vf = hcecp.sato3d(stackz, 1, return_vectors=True)
