...
```{python}
if verbose:
    tmp_graph = filter_graph(gx_all, lambda n: n['sigma_mask'] == sigmas[-1])
    ...
    w.add_shapes(draw_edges(tmp_pos, tmp_graph.edges()), shape_type='path', edge_color='weight', edge_width=0.1, edge_colormap='inferno', properties=props)
```
