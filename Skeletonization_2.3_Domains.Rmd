...
```{python}
w = napari.view_image(final_image)
w.add_image(sigma_mask > 1, colormap='red', blending='additive', visible=True)
#w.add_image(final_image >0, colormap='cyan', blending='additive', visible=True)
w.add_image(thin_mask, colormap='magenta', blending='additive', visible=True)
```
...
w.add_image(domains==30,opacity=0.75,colormap='red')
```
